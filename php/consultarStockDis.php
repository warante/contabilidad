		...
		<div class="row-fluid">
			...
			<div class="span12 thumbnail">
				...
				<?php 
					...
					{			
						echo '<tr><td><a href="consultarStockMod2.php?modelo=' . $filas2['modelo'] . '">' . $filas2['modelo'] . '</a></td><td>' . $filas2['cantidad'] . '</td><td>' . $filas2['fecha'] . '</td><td><button type="button" class="btn btn-success" onclick="window.location=\'registrarVenta.php?distribuidor=' . $_GET['distribuidor'] . '&modelo=' . $filas2['modelo'] . '&codigo=' . $filas2['cod_stock'] .'&cantidad=' . $filas2['cantidad'] . '\'">Vendida</button><button type="button" class="btn btn-warning" onclick="window.location=\'modificarStock.php?codigo=' . $filas2['cod_stock'] . '\'">Modificar</button></td></tr>';
